...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return si.um.feri.calculator.Calculator.internal_static_calculator_SumRequest_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return si.um.feri.calculator.Calculator.internal_static_calculator_SumRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            si.um.feri.calculator.SumRequest.class, si.um.feri.calculator.SumRequest.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof si.um.feri.calculator.SumRequest)) {
      return super.equals(obj);
    }
    si.um.feri.calculator.SumRequest other = (si.um.feri.calculator.SumRequest) obj;
  ...
  public static si.um.feri.calculator.SumRequest parseFrom(
  ...
  public static si.um.feri.calculator.SumRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static si.um.feri.calculator.SumRequest parseFrom(
  ...
  public static si.um.feri.calculator.SumRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static si.um.feri.calculator.SumRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static si.um.feri.calculator.SumRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(si.um.feri.calculator.SumRequest prototype) {
  ...
  public static final class Builder extends
      ...
      si.um.feri.calculator.SumRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return si.um.feri.calculator.Calculator.internal_static_calculator_SumRequest_descriptor;
    }
    ...
    // Construct using si.um.feri.calculator.SumRequest.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public si.um.feri.calculator.SumRequest getDefaultInstanceForType() {
      return si.um.feri.calculator.SumRequest.getDefaultInstance();
    }

    @java.lang.Override
    public si.um.feri.calculator.SumRequest build() {
      si.um.feri.calculator.SumRequest result = buildPartial();
    ...
    @java.lang.Override
    public si.um.feri.calculator.SumRequest buildPartial() {
      si.um.feri.calculator.SumRequest result = new si.um.feri.calculator.SumRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof si.um.feri.calculator.SumRequest) {
        return mergeFrom((si.um.feri.calculator.SumRequest)other);
      } else {
    ...
    public Builder mergeFrom(si.um.feri.calculator.SumRequest other) {
      if (other == si.um.feri.calculator.SumRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      si.um.feri.calculator.SumRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (si.um.feri.calculator.SumRequest) e.getUnfinishedMessage();
  ...
  private static final si.um.feri.calculator.SumRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new si.um.feri.calculator.SumRequest();
  }

  public static si.um.feri.calculator.SumRequest getDefaultInstance() {
