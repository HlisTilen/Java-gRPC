...
public final class GreetServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<si.um.feri.greet.GreetRequest,
      si.um.feri.greet.GreetResponse> getGreetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Greet",
      requestType = si.um.feri.greet.GreetRequest.class,
      responseType = si.um.feri.greet.GreetResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<si.um.feri.greet.GreetRequest,
      si.um.feri.greet.GreetResponse> getGreetMethod() {
    io.grpc.MethodDescriptor<si.um.feri.greet.GreetRequest, si.um.feri.greet.GreetResponse> getGreetMethod;
      ...
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetMethod = GreetServiceGrpc.getGreetMethod) == null) {
          GreetServiceGrpc.getGreetMethod = getGreetMethod =
              io.grpc.MethodDescriptor.<si.um.feri.greet.GreetRequest, si.um.feri.greet.GreetResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Greet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  si.um.feri.greet.GreetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  si.um.feri.greet.GreetResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<si.um.feri.greet.GreetManyTimesRequest,
      si.um.feri.greet.GreetManyTimesResponse> getGreetManyTimesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GreetManyTimes",
      requestType = si.um.feri.greet.GreetManyTimesRequest.class,
      responseType = si.um.feri.greet.GreetManyTimesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<si.um.feri.greet.GreetManyTimesRequest,
      si.um.feri.greet.GreetManyTimesResponse> getGreetManyTimesMethod() {
    io.grpc.MethodDescriptor<si.um.feri.greet.GreetManyTimesRequest, si.um.feri.greet.GreetManyTimesResponse> getGreetManyTimesMethod;
      ...
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetManyTimesMethod = GreetServiceGrpc.getGreetManyTimesMethod) == null) {
          GreetServiceGrpc.getGreetManyTimesMethod = getGreetManyTimesMethod =
              io.grpc.MethodDescriptor.<si.um.feri.greet.GreetManyTimesRequest, si.um.feri.greet.GreetManyTimesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GreetManyTimes"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  si.um.feri.greet.GreetManyTimesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  si.um.feri.greet.GreetManyTimesResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<si.um.feri.greet.LongGreetRequest,
      si.um.feri.greet.LongGreetResponse> getLongGreetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "LongGreet",
      requestType = si.um.feri.greet.LongGreetRequest.class,
      responseType = si.um.feri.greet.LongGreetResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<si.um.feri.greet.LongGreetRequest,
      si.um.feri.greet.LongGreetResponse> getLongGreetMethod() {
    io.grpc.MethodDescriptor<si.um.feri.greet.LongGreetRequest, si.um.feri.greet.LongGreetResponse> getLongGreetMethod;
    if ((getLongGreetMethod = GreetServiceGrpc.getLongGreetMethod) == null) {
      synchronized (GreetServiceGrpc.class) {
        if ((getLongGreetMethod = GreetServiceGrpc.getLongGreetMethod) == null) {
          GreetServiceGrpc.getLongGreetMethod = getLongGreetMethod =
              io.grpc.MethodDescriptor.<si.um.feri.greet.LongGreetRequest, si.um.feri.greet.LongGreetResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "LongGreet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  si.um.feri.greet.LongGreetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  si.um.feri.greet.LongGreetResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<si.um.feri.greet.GreetEveryoneRequest,
      si.um.feri.greet.GreetEveryoneResponse> getGreetEveryoneMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GreetEveryone",
      requestType = si.um.feri.greet.GreetEveryoneRequest.class,
      responseType = si.um.feri.greet.GreetEveryoneResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<si.um.feri.greet.GreetEveryoneRequest,
      si.um.feri.greet.GreetEveryoneResponse> getGreetEveryoneMethod() {
    io.grpc.MethodDescriptor<si.um.feri.greet.GreetEveryoneRequest, si.um.feri.greet.GreetEveryoneResponse> getGreetEveryoneMethod;
      ...
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetEveryoneMethod = GreetServiceGrpc.getGreetEveryoneMethod) == null) {
          GreetServiceGrpc.getGreetEveryoneMethod = getGreetEveryoneMethod =
              io.grpc.MethodDescriptor.<si.um.feri.greet.GreetEveryoneRequest, si.um.feri.greet.GreetEveryoneResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GreetEveryone"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  si.um.feri.greet.GreetEveryoneRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  si.um.feri.greet.GreetEveryoneResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<si.um.feri.greet.GreetWithDeadlineRequest,
      si.um.feri.greet.GreetWithDeadlineResponse> getGreetWithDeadlineMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GreetWithDeadline",
      requestType = si.um.feri.greet.GreetWithDeadlineRequest.class,
      responseType = si.um.feri.greet.GreetWithDeadlineResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<si.um.feri.greet.GreetWithDeadlineRequest,
      si.um.feri.greet.GreetWithDeadlineResponse> getGreetWithDeadlineMethod() {
    io.grpc.MethodDescriptor<si.um.feri.greet.GreetWithDeadlineRequest, si.um.feri.greet.GreetWithDeadlineResponse> getGreetWithDeadlineMethod;
      ...
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetWithDeadlineMethod = GreetServiceGrpc.getGreetWithDeadlineMethod) == null) {
          GreetServiceGrpc.getGreetWithDeadlineMethod = getGreetWithDeadlineMethod =
              io.grpc.MethodDescriptor.<si.um.feri.greet.GreetWithDeadlineRequest, si.um.feri.greet.GreetWithDeadlineResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GreetWithDeadline"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  si.um.feri.greet.GreetWithDeadlineRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  si.um.feri.greet.GreetWithDeadlineResponse.getDefaultInstance()))
  ...
  public static abstract class GreetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void greet(si.um.feri.greet.GreetRequest request,
        io.grpc.stub.StreamObserver<si.um.feri.greet.GreetResponse> responseObserver) {
     ...
     * </pre>
     */
    public void greetManyTimes(si.um.feri.greet.GreetManyTimesRequest request,
        io.grpc.stub.StreamObserver<si.um.feri.greet.GreetManyTimesResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<si.um.feri.greet.LongGreetRequest> longGreet(
        io.grpc.stub.StreamObserver<si.um.feri.greet.LongGreetResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<si.um.feri.greet.GreetEveryoneRequest> greetEveryone(
        io.grpc.stub.StreamObserver<si.um.feri.greet.GreetEveryoneResponse> responseObserver) {
    ...
    public void greetWithDeadline(si.um.feri.greet.GreetWithDeadlineRequest request,
        io.grpc.stub.StreamObserver<si.um.feri.greet.GreetWithDeadlineResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                si.um.feri.greet.GreetManyTimesRequest,
                si.um.feri.greet.GreetManyTimesResponse>(
                  this, METHODID_GREET_MANY_TIMES)))
          .addMethod(
            getLongGreetMethod(),
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
              new MethodHandlers<
                si.um.feri.greet.LongGreetRequest,
                si.um.feri.greet.LongGreetResponse>(
                  this, METHODID_LONG_GREET)))
          .addMethod(
            getGreetEveryoneMethod(),
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                si.um.feri.greet.GreetEveryoneRequest,
                si.um.feri.greet.GreetEveryoneResponse>(
                  this, METHODID_GREET_EVERYONE)))
          .addMethod(
            getGreetWithDeadlineMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                si.um.feri.greet.GreetWithDeadlineRequest,
                si.um.feri.greet.GreetWithDeadlineResponse>(
  ...
  public static final class GreetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreetServiceBlockingStub> {
     ...
     * </pre>
     */
    public si.um.feri.greet.GreetResponse greet(si.um.feri.greet.GreetRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<si.um.feri.greet.GreetManyTimesResponse> greetManyTimes(
        si.um.feri.greet.GreetManyTimesRequest request) {
  ...
  public static final class GreetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<si.um.feri.greet.GreetResponse> greet(
        si.um.feri.greet.GreetRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<si.um.feri.greet.GreetWithDeadlineResponse> greetWithDeadline(
        si.um.feri.greet.GreetWithDeadlineRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREET:
          serviceImpl.greet((si.um.feri.greet.GreetRequest) request,
              (io.grpc.stub.StreamObserver<si.um.feri.greet.GreetResponse>) responseObserver);
          break;
        case METHODID_GREET_MANY_TIMES:
          serviceImpl.greetManyTimes((si.um.feri.greet.GreetManyTimesRequest) request,
              (io.grpc.stub.StreamObserver<si.um.feri.greet.GreetManyTimesResponse>) responseObserver);
          break;
        case METHODID_GREET_WITH_DEADLINE:
          serviceImpl.greetWithDeadline((si.um.feri.greet.GreetWithDeadlineRequest) request,
              (io.grpc.stub.StreamObserver<si.um.feri.greet.GreetWithDeadlineResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return si.um.feri.greet.Greet.getDescriptor();
    }
